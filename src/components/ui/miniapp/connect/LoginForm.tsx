...
const LoginForm = forwardRef<HTMLDivElement, LoginFormProps>(({ isConnected, onLogin, className = '' }, ref) => {
  return (
    <div ref={ref} className={`w-full transition-opacity ${className} px-6`}>
      ...
      <p className="text-center text-text/50 text-xs mt-3 leading-relaxed">
        ...
        <a href="#" className="underline hover:text-text/70 transition-colors">
          Terms of Service
        </a>{' '}
        and{' '}
        <a href="#" className="underline hover:text-text/70 transition-colors">
