...
const Onboarding = forwardRef<HTMLDivElement, OnboardingProps>(({ className = '' }, ref) => {
      ...
      case 0:
        return (
          <div className="flex flex-col items-center space-y-4">
            ...
            >
              <Image
                src="/assets/onboardings/stablecoin_group1.png"
            ...
            >
              <Image
                src="/assets/onboardings/stablecoin_group2.png"
            ...
            >
              <Image
                src="/assets/onboardings/stablecoin_group3.png"
      ...
      case 1:
        return (
          <div className="flex flex-col items-center space-y-4">
            ...
            >
              <Image
                src="/assets/onboardings/rwa_group1.png"
                alt="RWA Group 1"
                width={160}
                height={28}
                className="object-contain"
            ...
            >
              <Image
                src="/assets/onboardings/rwa_group2.png"
                alt="RWA Group 2"
                width={170}
                height={24}
                className="object-contain"
            ...
            >
              <Image
                src="/assets/onboardings/rwa_group3.png"
                alt="RWA Group 3"
                width={120}
                height={20}
                className="object-contain"
      ...
      case 2:
        return (
          <div className="flex flex-col items-center space-y-4">
            ...
            >
              <Image
                src="/assets/onboardings/multichain_group1.png"
            ...
            >
              <Image
                src="/assets/onboardings/multichain_group2.png"
      ...
      case 3:
        return (
          <div className="flex flex-col items-center space-y-4">
            ...
            >
              <Image
                src="/assets/onboardings/partner_group1.png"
                alt="Partner Group 1"
                width={320}
                height={28}
                className="object-contain"
            ...
            >
              <Image
                src="/assets/onboardings/partner_group2.png"
                alt="Partner Group 2"
                width={280}
                height={28}
                className="object-contain"
  ...
  return (
    <div ref={ref} className={`relative w-full flex flex-col items-center justify-center ${className}`}>
      <div
        ref={backgroundCircleRef}
        className="absolute inset-0 h-screen flex justify-center z-10 pointer-events-none -translate-y-8"
      >
        <Image
          src="/assets/backgrounds/bg_circle_onboarding.png"
          ...
          {options.map((option, index) => (
            <div
              ...
              className={`flex-shrink-0 cursor-pointer font-semibold text-lg transition-all duration-300 snap-center flex flex-col items-center ${
                selectedOption === index ? 'text-text' : 'text-text/40'
              }`}
      ...
      <div ref={bottomContentRef} className="flex flex-col items-center z-10">
        <div className="flex justify-center">
          <Image
            src="/assets/onboardings/arrow.png"
        ...
        <div className="w-full flex flex-col items-center mt-4">
          <span className="text-center text-text/40 text-xs leading-relaxed">Effortless stablecoin lending</span>
