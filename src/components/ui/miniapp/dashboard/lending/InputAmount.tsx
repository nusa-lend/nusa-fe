...
export default function InputAmount({ selectedChain, onBack, onLend }: InputAmountProps) {
    ...
    <div className="w-full max-w-md mx-auto space-y-5 pb-4 bg-white">
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full overflow-hidden flex items-center justify-center">
              <Image
                src="/assets/onboarding/stablecoin/1.png"
                alt="Token"
                width={32}
                height={32}
                className="object-contain"
          ...
          <div className="flex items-center gap-2">
            <span className="text-gray-900 font-semibold">IDR</span>
            ...
            <div className="flex-1">
              ...
              <AnimatePresence initial={false}>
                {isDisclaimerExpanded && (
                  ...
                  >
                    <p>
                      Earning involves risk. Past performance is not
                      indicative of future results. The principal amount and returns
                      are not guaranteed.
                    </p>
                  </motion.div>
                )}
      ...
      <button
        ...
        className={`w-full py-3.5 rounded-xl font-semibold text-[15px] text-white transition ${
          hasAmount && !isInsufficientBalance
